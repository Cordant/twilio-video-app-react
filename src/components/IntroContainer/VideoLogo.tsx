...
export default function VideoLogo() {
  ...
  return (
    <img
      src="https://s3-eu-west-1.amazonaws.com/assets.cordantconnect.com/images/logos/pmp-header-logo2x.png"
      alt=""
      className={classes.logo}
    />
    // <svg xmlns="https://s3-eu-west-1.amazonaws.com/assets.cordantconnect.com/images/logos/pmp-header-logo2x.png" width="96" height="96" viewBox="0 0 96 96">
